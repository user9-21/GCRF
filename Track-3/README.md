...
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/
source script.sh
...
## 2.  BigQuery for Machine Learning
...
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/2.2.Predict-Visitor-Purchases-with-a-Classification-Model-in-BQML.sh
source script.sh
...
#### [3.2.Explore and Create Reports with Data Studio](https://github.com/user9-21/GCRF/blob/main/Track-3/.sh) | https://www.cloudskillsboost.google/focuses/3614
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/
source script.sh
...
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/3.3.Creating-Permanent-Tables-and-Access-Controlled-Views-in-BigQuery.sh
source script.sh
...
#### [5.3.Tracking Cryptocurrency Exchange Trades with Google Cloud Platform in Real-Time](https://github.com/user9-21/GCRF/blob/main/Track-3/.sh) | https://www.cloudskillsboost.google/focuses/5570
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/
source script.sh
...
## 8.  BigQuery for Data Warehousing
...
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/8.1.BigQuery-Qwik-Start-Command-Line.sh
source script.sh
...
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/8.2.Creating-a-Data-Warehouse-Through-Joins-and-Unions.sh
source script.sh
...
```
curl -o script.sh  https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/8.3.Creating-Date-Partitioned-Tables-in-BigQuery.sh
source script.sh
...
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/8.4.Troubleshooting-and-Solving-Data-Join-Pitfalls.sh
source script.sh
...
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/8.5.Working-with-JSON-Arrays-and-Structs-in-BigQuery.sh
source script.sh

```

#### [8.6.Build and Execute MySQL, PostgreSQL, and SQLServer to Data Catalog Connectors](https://github.com/user9-21/GCRF/blob/main/Track-3/8.6.Build-and-Execute-MySQL-PostgreSQL-and-SQLServer-to-Data-Catalog-Connectors.sh) | https://www.cloudskillsboost.google/focuses/11999
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/8.6.Build-and-Execute-MySQL-PostgreSQL-and-SQLServer-to-Data-Catalog-Connectors.sh
source script.sh
...
#### [9.6.Predict Baby Weight with TensorFlow on AI Platform](https://github.com/user9-21/GCRF/blob/main/Track-3/.sh) | https://www.cloudskillsboost.google/focuses/607
```
curl -o script.sh https://raw.githubusercontent.com/user9-21/GCRF/main/Track-3/
source script.sh
