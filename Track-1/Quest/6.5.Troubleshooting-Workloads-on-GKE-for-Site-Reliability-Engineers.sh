...
Enter the following options on the Create logs metric page:
 ...
 Filter Selection  : "
 tput setaf 6;echo '                     resource.labels.cluster_name="cloud-ops-sandbox" AND resource.labels.namespace_name="default" 
                    AND resource.type="k8s_container" AND labels.k8s-pod/app="recommendationservice" AND severity>=ERROR'
tput sgr0; 

completed "Task 1"
PROJECT_NUMBER=$(gcloud projects describe $GOOGLE_CLOUD_PROJECT --format='value(projectNumber)')
warning "Open ${CYAN} https://console.cloud.google.com/monitoring/services/$PROJECT_NUMBER/ist:$GOOGLE_CLOUD_PROJECT-zone-us-central1-b-cloud-ops-sandbox-default-recommendationservice?project=$GOOGLE_CLOUD_PROJECT&pageState=(%22interval%22:())
${YELLOW}
